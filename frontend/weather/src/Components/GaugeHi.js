...
// Themes end
class GaugeHi extends Component{
    ...
    Gauge(){        
        ...
        let chart = am4core.create("GaugeHi", am4charts.GaugeChart);
        ...
        setInterval(() =>{
            let value = this.props.iotdata.Hi;            
    ...
    render() {  
        return (  
            <div id="GaugeHi" className="gauge"/>
        )  
    }  
